 ...
 */
export declare type ResponseBaseUnion = ResponseBase | IdentifiableUnion;
/**
 * Response base.
 */
 ...
 */
export declare type IdentifiableUnion = Identifiable | ResponseUnion;
/**
 ...
 */
export declare type ResponseUnion = Response | ImageKnowledge | ErrorResponse | ThingUnion;
/**
 ...
 */
export declare type ThingUnion = Thing | ImageTag | Organization | OfferUnion | CreativeWorkUnion | Person | IntangibleUnion;
/**
 * Defines a thing.
 */
 ...
 */
export declare type IntangibleUnion = Intangible | StructuredValueUnion;
/**
 ...
 */
export declare type StructuredValueUnion = StructuredValue | Point2D | NormalizedQuadrilateral;
/**
 ...
 */
export declare type CreativeWorkUnion = CreativeWork | ActionUnion | MediaObjectUnion | Recipe;
/**
 ...
 */
export declare type ActionUnion = Action | ImageActionUnion;
/**
 * Defines an action.
 */
 ...
 */
export declare type ImageActionUnion = ImageAction | ImageEntityAction | ImageModuleAction | ImageRecipesAction | ImageRelatedSearchesAction | ImageShoppingSourcesAction;
/**
 ...
 */
export declare type PropertiesItemUnion = PropertiesItem | RatingUnion;
/**
 * Defines an item.
 */
 ...
 */
export declare type RatingUnion = Rating | AggregateRating;
/**
 * Defines a rating.
 */
 ...
 */
export declare type OfferUnion = Offer | AggregateOffer;
/**
 ...
 */
export declare type MediaObjectUnion = MediaObject | ImageObject;
/**
 ...
 * @enum {string}
 */
export declare type ItemAvailability = 'Discontinued' | 'InStock' | 'InStoreOnly' | 'LimitedAvailability' | 'OnlineOnly' | 'OutOfStock' | 'PreOrder' | 'SoldOut';
/**
 ...
 * @enum {string}
 */
export declare type ErrorCode = 'None' | 'ServerError' | 'InvalidRequest' | 'RateLimitExceeded' | 'InvalidAuthorization' | 'InsufficientAuthorization';
/**
 ...
 * @enum {string}
 */
export declare type ErrorSubCode = 'UnexpectedError' | 'ResourceError' | 'NotImplemented' | 'ParameterMissing' | 'ParameterInvalidValue' | 'HttpNotAllowed' | 'Blocked' | 'AuthorizationMissing' | 'AuthorizationRedundancy' | 'AuthorizationDisabled' | 'AuthorizationExpired';
/**
 ...
 * @enum {string}
 */
export declare type SafeSearch = 'Off' | 'Moderate' | 'Strict';
/**
 * Contains response data for the visualSearch operation.
 */
export declare type ImagesVisualSearchResponse = ImageKnowledge & {
    /**
